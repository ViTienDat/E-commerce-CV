      ...
      <div className="flex flex-col gap-10 none w-full">
        <div className="text-[14px] bg-[#f5f5f5] py-[15px] w-full ">
          <div className="w-main m-auto">
            ...
            / <span className="text-main">My cart</span>
          </div>
        </div>
        <div className="w-main m-auto text-[24px]">
          <h1>My cart</h1>
        </div>
        ...
        <div className="w-main m-auto flex justify-between text-[15px] ">
          <div
            onClick={() => navigate(`/${path.PRODUCTS}/all`)}
            className="transition-colors h-[50px] duration-50 font-semibold py-2 px-6 bg-gray-100 flex items-center cursor-pointer hover:bg-main2 hover:text-white"
          >
            TIẾP TỤC MUA HÀNG
          </div>
          <div>
